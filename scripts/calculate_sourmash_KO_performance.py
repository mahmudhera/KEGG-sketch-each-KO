...
def parse_args():
    ...
    parser.add_argument("tool_ko_abundance_filename", type=str, help="The full path to the sourmash KO abundance filename. This should be generated by the run_sourmash_gather.py script.")
